...
export class Todos extends React.Component {
    constructor(props) {
        ...
        this.handleAddTodo = this
            .handleAddTodo
            .bind(this);
        this.handleTodoSearch = this
            .handleTodoSearch
            .bind(this);
        this.handleTodoCompleted = this
            .handleTodoCompleted
            .bind(this);
    }
    ...
    componentWillMount() {
        ...
        // [... this.state.todos,{todo:"make kachori", id:uuid(), isCompleted:
        // false},{todo:"make pizza", id:uuid(), isCompleted: true}]
    }
